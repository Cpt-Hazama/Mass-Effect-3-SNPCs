...
SWEP.PrintName					= "Geth Rocket Launcher"
...
SWEP.Category					= "Mass Effect 3"
	-- Main Settings ---------------------------------------------------------------------------------------------------------------------------------------------
SWEP.WorldModel					= "models/cpthazama/masseffect3/weapons/gethrocketlauncher.mdl" -- The world model (Third person, when a NPC is holding it, on ground, etc.)
