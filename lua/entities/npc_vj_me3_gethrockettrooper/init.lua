...
-----------------------------------------------*/
ENT.Model = {"models/cpthazama/masseffect3/geth_rockettrooper.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want
